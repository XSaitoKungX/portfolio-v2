...
export function Nav() {
  ...
  return (
    <header
      ...
      style={{
        backgroundColor: isScrolled ? 'rgba(var(--background-rgb, 0, 0, 0), 0.8)' : 'transparent',
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <nav className="flex items-center justify-between">
          ...
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center gap-1 p-1.5 rounded-2xl" style={{ backgroundColor: 'rgba(var(--background-rgb, 0, 0, 0), 0.3)', backdropFilter: 'blur(10px)' }}>
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              style={{
                ...
                color: isMobileMenuOpen ? 'var(--primary-foreground)' : 'var(--foreground)',
                boxShadow: isMobileMenuOpen ? '0 4px 15px rgba(var(--primary-rgb, 99, 102, 241), 0.3)' : 'none',
              }}
                    ...
                    <Link
                      ...
                      style={{
                        ...
                        color: isActive
                          ...
                          : 'var(--foreground)',
                        fontFamily: 'var(--font-body)',
                        boxShadow: isActive ? '0 4px 15px rgba(var(--primary-rgb, 99, 102, 241), 0.3)' : 'none',
                      }}
                    >
